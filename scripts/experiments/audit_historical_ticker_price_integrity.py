...
_IMPLEMENTATION = expose_script_implementation(
    globals(),
    target=Path(__file__).resolve().parent / "legacy/audit_historical_ticker_price_integrity.py",
    module_name="alpharank_script_compat_audit_historical_ticker_price_integrity",
)
