...
_IMPLEMENTATION = expose_script_implementation(
    globals(),
    target=Path(__file__).resolve().parent / "operations/compare_multihorizon_feature_modes.py",
    module_name="alpharank_script_compat_compare_multihorizon_feature_modes",
)
