#!/usr/bin/env python3
"""Render the central AlphaRank research dashboard."""
...
from alpharank.reporting.central_research_data import (
    DEFAULT_OUTPUT_DIR,
    DIAGNOSTICS_DIR,
    PROJECT_ROOT,
    _clean,
    _hash,
    _maximum_date,
    _write_monthly_shap_sidecars,
    build_payload,
)

__all__ = ["_maximum_date", "advanced_performance_statistics"]
        ...
        json.dumps(
            {
                ...
                "semantics": {
                    ...
                    "legacy_signal_benchmark": (
                        "spy_price_return_close; not used as the standard performance benchmark"
                    ),
                    "monthly_shap_filter": (
                    ...
                    "shap_sampling": (
                        "monthly views are exhaustive; all-month overview is 80 rows per fold"
                    ),
                    "cagr_attribution": (
