...
_IMPLEMENTATION = expose_script_implementation(
    globals(),
    target=Path(__file__).resolve().parent / "reports/render_alpha_shap_portfolio_report.py",
    module_name="alpharank_script_compat_render_alpha_shap_portfolio_report",
)
