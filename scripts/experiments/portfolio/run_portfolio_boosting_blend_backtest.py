...
_TRADING_MODULE = load_module_from_path(
    "alpharank_experiment_tradable_ema_trading_backtest",
    Path(__file__).resolve().parents[1]
    / "modeling"
    / "run_tradable_ema_regression_trading_backtest.py",
)
DEFAULT_LEGACY_MONTHLY_RETURNS = _TRADING_MODULE.DEFAULT_LEGACY_MONTHLY_RETURNS
build_spy_curve = _TRADING_MODULE.build_spy_curve
load_legacy_curves = _TRADING_MODULE.load_legacy_curves
