...
_IMPLEMENTATION = expose_script_implementation(
    globals(),
    target=Path(__file__).resolve().parent / "ingestion/refresh_sec_companyfacts_from_cache.py",
    module_name="alpharank_script_compat_refresh_sec_companyfacts_from_cache",
)
