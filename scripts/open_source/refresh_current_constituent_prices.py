...
_IMPLEMENTATION = expose_script_implementation(
    globals(),
    target=Path(__file__).resolve().parent / "ingestion/refresh_current_constituent_prices.py",
    module_name="alpharank_script_compat_refresh_current_constituent_prices",
)
