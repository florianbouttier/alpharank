...
def main() -> None:
    ...
    _run_python(
        ...
        args=[
            "scripts/open_source/ingestion/refresh_sec_companyfacts_from_cache.py",
            "--raw-dir",
            str(probe_raw_dir),
            "--cache-dir",
            str(probe_cache_dir),
    ...
    _run_python(
        project_root=project_root,
        args=[
            "scripts/open_source/publication/build_sec_output_package.py",
            "--raw-source-dir",
            str(probe_raw_dir),
            "--output-dir",
    ...
    _run_python(
        project_root=project_root,
        args=[
            "scripts/open_source/reporting/build_sec_quality_dashboard.py",
            "--sec-output-dir",
            str(probe_output_dir),
            "--output-dir",
    ...
    _run_python(
        project_root=project_root,
        args=[
            "scripts/open_source/reporting/build_sec_core_kpi_yearly_report.py",
            "--sec-output-dir",
            str(probe_output_dir),
            "--quality-dir",
            str(probe_quality_dir),
    ...
    _run_python(
        project_root=project_root,
        args=[
            "scripts/open_source/publication/build_sec_overlay_package.py",
            "--primary-sec-dir",
            str(probe_output_dir),
            "--secondary-sec-dir",
