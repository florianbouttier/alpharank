...
_IMPLEMENTATION = expose_script_implementation(
    globals(),
    target=Path(__file__).resolve().parent / "publication/build_roll_forward_price_package.py",
    module_name="alpharank_script_compat_build_roll_forward_price_package",
)
