...
TARGETED_CI_TESTS = (
    (
        ...
        "tests/unit/test_code_inventory.py",
        "tests/unit/test_data_location_inventory.py",
        "tests/unit/test_dependency_sync.py",
        "tests/unit/test_documentation_structure.py",
        "tests/unit/test_error_handling_policy.py",
        ...
        "tests/unit/test_script_archival_audit.py",
        "tests/unit/test_test_catalog.py",
        "tests/unit/test_test_suite_classification.py",
    ),
)
