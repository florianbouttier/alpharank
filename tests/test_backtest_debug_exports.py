    ...
    model_frame = pl.DataFrame(
        {
            ...
            "decision_month": [date(2020, 1, 1), date(2020, 1, 1), date(2020, 2, 1)],
            "holding_month": [date(2020, 2, 1), date(2020, 2, 1), date(2020, 3, 1)],
            "decision_asof_date": [date(2020, 1, 31), date(2020, 1, 31), date(2020, 2, 29)],
            "holding_asof_date": [date(2020, 2, 29), date(2020, 2, 29), date(2020, 3, 31)],
            "benchmark_holding_asof_date": [date(2020, 2, 29), date(2020, 2, 29), date(2020, 3, 31)],
            "holding_period_complete": [True, True, True],
    ...
    predictions = pl.DataFrame(
        {
            ...
            "decision_month": [date(2020, 1, 1), date(2020, 1, 1)],
            "holding_month": [date(2020, 2, 1), date(2020, 2, 1)],
            "decision_asof_date": [date(2020, 1, 31), date(2020, 1, 31)],
            "holding_asof_date": [date(2020, 2, 29), date(2020, 2, 29)],
            "benchmark_holding_asof_date": [date(2020, 2, 29), date(2020, 2, 29)],
