...
Ce dossier conserve les journaux, anciennes pages d'onboarding et rapports
datés. Leur contenu reste utile pour expliquer une décision passée, mais il ne
décrit pas automatiquement l'état courant du projet.

- `reports/` : audits et rapports datés.
