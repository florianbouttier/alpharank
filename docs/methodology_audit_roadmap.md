...
| 2026-08-18 | `RUN-004` | Codex | Gate G7 | Implémenté — bloqué | Validé provisoire | `293e835`, `8bf1680` | Replay commun `common_v2_provisional5` : 6 305 holdings, 178 mois, 4 stratégies, erreur `3,33e-16` ; 193 lignes retirées par appartenance et 1 017 par ouverture d'exécution avant classement | `comparison_eligible=false` tant que 9 positions / 7 tickers du journal ne sont pas sourcées ; les échecs SCG antérieurs sont conservés |
