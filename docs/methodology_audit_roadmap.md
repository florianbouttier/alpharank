...
- État : les 41 actions initiales sont traitées (3 validées, 38 implémentées) ; `RUN-001` est validée et quatre actions d'exécution restent à produire pour achever et rapprocher le replay causal `v2`
...
| `v2-causal` | En cours — snapshot scellé | Legacy + Boosting corrigés | `v2-causal-2975e65156b0-20260818T085346Z` | `e98478728a5396ae3f3683c33ba6d9c51479788d` pour le scellement | `outputs/methodology_v2/run_001/v2-causal-snapshot/causal_v2_snapshot_manifest.json` (`e55b56c2…f0601`) | À déterminer par les replays `RUN-002` à `RUN-004` | Snapshot validé ; performances, rapprochement et promotion encore interdits avant `RUN-002` à `RUN-005` |
