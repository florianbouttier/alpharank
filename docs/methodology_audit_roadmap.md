...
9. **Gate G8 — Go-live mensuel et publication AlphaRank** : `LIVE-001` à
   `LIVE-003`, `LIVE-005` à `LIVE-011`, `SITE-001` et `DOC-003`. Le signal de trading reste
...
| Go-live et publication | 13 | 9 | 3 | 1 | 4 | 7 | 53,8 % |
| **Total** | **67** | **34** | **25** | **8** | **44** | **21** | **31,3 %** |
