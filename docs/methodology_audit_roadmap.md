...
9. **Gate G8 — Go-live mensuel et publication AlphaRank** : `LIVE-001` à
   `LIVE-003`, `LIVE-005` à `LIVE-016`, `SITE-001` et `DOC-003`. Le signal de trading reste
...
| Go-live et publication | 18 | 14 | 3 | 1 | 8 | 7 | 38,9 % |
| **Total** | **72** | **39** | **25** | **8** | **48** | **21** | **29,2 %** |
