...
- État : Gate G0 franchie et vingt-neuf corrections supplémentaires implémentées ; replay causal `v2` et promotion encore à faire
...
| Dashboard et IBKR | 6 | 1 | 4 | 1 | 1 | 0 | 0 % |
| Qualité et documentation | 5 | 2 | 1 | 2 | 1 | 0 | 0 % |
| **Total** | **41** | **12** | **22** | **7** | **29** | **3** | **7,3 %** |
