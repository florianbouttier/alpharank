...
9. **Gate G8 — Go-live mensuel et publication AlphaRank** : `LIVE-001` à
   `LIVE-003`, `LIVE-005` à `LIVE-009`, `SITE-001` et `DOC-003`. Le signal de trading reste
...
| Go-live et publication | 11 | 7 | 3 | 1 | 2 | 7 | 63,6 % |
| **Total** | **65** | **32** | **25** | **8** | **42** | **21** | **32,3 %** |
