...
9. **Gate G8 — Go-live mensuel et publication AlphaRank** : `LIVE-001` à
   `LIVE-003`, `LIVE-005` à `LIVE-015`, `SITE-001` et `DOC-003`. Le signal de trading reste
...
| Go-live et publication | 17 | 13 | 3 | 1 | 8 | 7 | 41,2 % |
| **Total** | **71** | **38** | **25** | **8** | **48** | **21** | **29,6 %** |
