...
9. **Gate G8 — Go-live mensuel et publication AlphaRank** : `LIVE-001` à
   `LIVE-003`, `LIVE-005` à `LIVE-012`, `SITE-001` et `DOC-003`. Le signal de trading reste
...
| Go-live et publication | 14 | 10 | 3 | 1 | 5 | 7 | 50,0 % |
| **Total** | **68** | **35** | **25** | **8** | **45** | **21** | **30,9 %** |
