...
9. **Gate G8 — Go-live mensuel et publication AlphaRank** : `LIVE-001` à
   `LIVE-003`, `LIVE-005` à `LIVE-013`, `SITE-001` et `DOC-003`. Le signal de trading reste
...
| Go-live et publication | 15 | 11 | 3 | 1 | 6 | 7 | 46,7 % |
| **Total** | **69** | **36** | **25** | **8** | **46** | **21** | **30,4 %** |
