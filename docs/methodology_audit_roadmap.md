...
9. **Gate G8 — Go-live mensuel et publication AlphaRank** : `LIVE-001` à
   `LIVE-003`, `LIVE-005` à `LIVE-017`, `SITE-001` et `DOC-003`. Le signal de trading reste
...
| Go-live et publication | 19 | 15 | 3 | 1 | 8 | 7 | 36,8 % |
| **Total** | **73** | **40** | **25** | **8** | **48** | **21** | **28,8 %** |
