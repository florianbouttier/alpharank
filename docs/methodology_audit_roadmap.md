...
- État : les 41 actions initiales sont traitées (3 validées, 38 implémentées) ; `RUN-001` et `RUN-002` sont validées, `RUN-003` est bloquée fail-closed par 595 cibles H6 matures sans événement terminal sourcé, et `RUN-004`/`RUN-005` sont implémentées mais non exécutables avant résolution de ce blocage
...
| `v2-causal` | En cours — Legacy validé, Boosting bloqué | Legacy + Boosting corrigés | `v2-causal-2975e65156b0-20260818T085346Z` | `32fc41e` pour le replay Legacy validé ; `b17e456` pour le correctif de cible Boosting | Snapshot `RUN-001` (`e55b56c2…f0601`) ; Legacy `outputs/methodology_v2/run_002/2026-08-18/runs/20260818_115710/legacy_v2_replay_manifest.json` | Legacy : août 2011 à juillet 2026 ; Boosting : non produit | Legacy est rejouable ; Boosting, comparaison commune, impact économique et promotion restent interdits jusqu'à résolution sourcée des 595 cibles H6 terminales |
