...
9. **Gate G8 — Go-live mensuel et publication AlphaRank** : `LIVE-001` à
   `LIVE-003`, `LIVE-005` à `LIVE-008`, `SITE-001` et `DOC-003`. Le signal de trading reste
...
| Go-live et publication | 10 | 6 | 3 | 1 | 1 | 5 | 50 % |
| **Total** | **64** | **31** | **25** | **8** | **41** | **19** | **29,7 %** |
